...
Список составлен по официальному перечню доменов Epic для белых списков. Домены давно
закрытых игр (Paragon, Battle Breakers, Robo Recall и прочие) в набор не вошли: они
ничего не обслуживают, а часть этих доменов уже не принадлежит Epic.
